...
const DearOfDay = () => {
    ...
    useEffect(() => {
        const fetchRestaurantes = async () => {
            try {
                ...
                setError(t('ERRO_AO_CARREGAR_RESTAURANTES'));
            } finally {
                setLoading(false);
            }
        };
    ...
    const fetchVoto = async () => {
        ...
        try {
            ...
            setTimeout(() => {
                setModalOpen(false);
            }, 2000); // Fechar modal de sucesso após 2 segundos
        } catch (error) {
            ...
            <div className="flex lg:flex-row flex-col justify-center items-center ">
                <div className="flex flex-col px-[60px] lg:w-[45%] w-[100%] 2xl:w-[36%] xl:w-[38%] ml-[4%]  border-r ">
                    <p className="text-white text-[12px] lg:mb-[30px]">
                        {t('QUAL_CARDAPIO_TE_AGRADOU_MAIS')}
                    </p>
            ...
            {modalOpen && (
                <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
                    <div className="bg-white p-12 lg:w-[40%] 2xl:w-[30%] text-[86%] border border-gray-300 flex items-center justify-center">
                        <p className="lg:mr-[30px]">{t('VOTO_ENVIADO_COM_SUCESSO')}</p>
